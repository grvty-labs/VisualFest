const initialState = {
  ...
  conferences: [
    ...
    {
      owner: 7,
      title: '¡ESTÁ VIVO! ANIMARSE A ANIMAR',
      date: 27,
      timestart: '17:00 hrs',
      timeend: '18:00 hrs',
      area: 'Diseño, 3D y VFX',
      image: '/images/events/esta_vivo.jpg',
      description: [
        '¿3D o 2D? ¿Motion graphics o personajes? ¿Cortometrajes o comerciales? ¿Cómo ser un artista 3D y no perder el alma en el intento?. Aún lo estamos descifrando, pero les contamos lo que nos ha funcionado y lo que no.',
      ],
    },
    {
      owner: 8,
      ...
      timeend: '11:00 hrs',
      area: 'Ilustración',
      image: '/images/events/roberto_soriano.jpg',
      description: [
    ...
    },
    {
      ...
      timeend: '12:00 hrs',
      area: 'Ilustración',
      image: '/images/events/jesus_rodolfo.jpg',
      description: [
        'Manifiesto personal sobre el desarrollo y evolución constante de mi carrera. Pequeño aporte que intenta abrir el panorama de las posibilidades e inquietudes del futuro diseñador/ilustrador.',
      ],
    },
    {
      owner: 10,
      title: 'El Proceso del Diseño',
      date: 28,
      timestart: '12:00 hrs',
      timeend: '13:30 hrs',
      area: 'Diseño Gráfico',
      image: '/images/events/luis_almeida.jpg',
      description: [
        'Sin descripción.',
      ],
    },
    {
      owner: 11,
      title: 'Herramientas digitales de diseño web',
      date: 28,
      timestart: '14:00 hrs',
      timeend: '15:00 hrs',
      area: 'Pendiente',
      ...
      description: [
        'El proceso del diseño web ha cambiado gracias a las herramientas digitales que lo hacen más fácil y eficiente. ¿Nos podemos librar de Adobe?',
      ],
    },
    {
      owner: 12,
    ...
    },
    {
      ...
      timeend: '18:00 hrs',
      area: 'Edición de publicaciones y diseño editorial',
      image: '/images/events/jorge_buenn.jpg',
      description: [
        'Ya se habla del nuerodiseño, pero hay mitos y una general incomprensión de lo que las neurociencias pueden aportar a nuestras disciplinas. ¿Podemos servirnos de ellas?',
      ],
    },
    {
      owner: 15,
